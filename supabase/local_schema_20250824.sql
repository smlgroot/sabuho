...
ALTER TABLE ONLY "public"."user_profiles"
    ADD CONSTRAINT "user_profiles_emotional_state_id_fkey" FOREIGN KEY ("emotional_state_id") REFERENCES "public"."emotional_profiles"("id");



ALTER TABLE ONLY "public"."user_profiles"
    ADD CONSTRAINT "user_profiles_peak_hours_id_fkey" FOREIGN KEY ("peak_hours_id") REFERENCES "public"."circadian_preferences"("id");



ALTER TABLE ONLY "public"."user_profiles"
    ADD CONSTRAINT "user_profiles_privacy_id_fkey" FOREIGN KEY ("privacy_id") REFERENCES "public"."privacy_settings"("id");



ALTER TABLE ONLY "public"."user_profiles"
    ADD CONSTRAINT "user_profiles_streaks_id_fkey" FOREIGN KEY ("streaks_id") REFERENCES "public"."streaks"("id");
...
CREATE POLICY "quizzes_modify_own" ON "public"."quizzes" USING (("auth"."uid"() = "user_id")) WITH CHECK (("auth"."uid"() = "user_id"));
