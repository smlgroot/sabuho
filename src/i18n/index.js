...
const resources = {
  ...
  es: {
    translation: {
      ...
      "Use a valid domain code to unlock learning paths and challenges.": "Usa un código de dominio válido para desbloquear rutas de aprendizaje y desafíos.",
      ...
      "Add a domain code to get started!": "¡Agrega un código de dominio para comenzar!",
      ...
      "Enter a domain code to get started 🔑": "Ingresa un código de dominio para comenzar 🔑",
      "Domain code": "Código de dominio",
      "Enter your domain code": "Ingresa tu código de dominio",
      ...
      "Focus Areas": "Áreas de mejora",
      "Strengths": "Fortalezas",
      "Performance Overview": "Resumen Desempeño",
      ...
      "Domain Codes": "Códigos de Dominio",
      "Claimed": "Reclamado",
      "Available": "Disponible",
      "No codes created yet.": "Aún no se han creado códigos.",
      "Insufficient Credits": "Créditos Insuficientes",
      "You need credits to create domain codes. You currently have": "Necesitas créditos para crear códigos de dominio. Actualmente tienes",
      ...
      "This domain code has already been added to your library": "Este código de dominio ya ha sido agregado a tu biblioteca",
      "You have already claimed this specific domain code": "Ya has reclamado este código de dominio específico",
      "This domain is already in your library": "Este dominio ya está en tu biblioteca",
